            ...
            <Navbar bg="transparent" variant="light" expand="lg">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ml-auto">
                        ...
                        <Link className="mr-3 h5 navLink text-decoration-none" to="/class">Our Classes</Link>
                        ...
                        <Link className="mr-3 h5 navLink text-decoration-none" to="/pricePlan">Pricing</Link>
